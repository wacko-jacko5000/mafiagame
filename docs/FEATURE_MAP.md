...
- `player`: profile, persistent foundation state, baseline resources, and lazy energy regeneration.
...
- `inventory`: item ownership and consumption.
- `economy`: wallets, sinks, faucets, transfers.
- `businesses`: passive income and upgrade paths.
- `market`: player-driven listing and direct item trading.

## Social domination systems

- `gangs`: membership, roles, and gang formation.
- `territory`: district ownership, current control state, manual cooldown-based district payouts, and minimal war flow.
- `leaderboard`: ranked public competition.
