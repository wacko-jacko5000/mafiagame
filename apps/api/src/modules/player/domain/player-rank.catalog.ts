...
export const playerRankCatalog: readonly PlayerRankDefinition[] = [
...
export function getPlayerRankByLevel(level: number): PlayerRankDefinition | undefined {
  return playerRankCatalog.find((rank) => rank.level === level);
}
