...
exports.starterMissionCatalog = void 0;
exports.getMissionById = getMissionById;
function mission(row) {
    return {
        ...row,
...
function getMissionById(missionId) {
    return exports.starterMissionCatalog.find((mission) => mission.id === missionId);
}
