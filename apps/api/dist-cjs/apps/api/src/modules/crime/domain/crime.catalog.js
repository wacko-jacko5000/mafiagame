...
exports.starterCrimeCatalog = void 0;
exports.getCrimeById = getCrimeById;
exports.applyCrimeBalanceOverride = applyCrimeBalanceOverride;
exports.resetStarterCrimeCatalog = resetStarterCrimeCatalog;
function buildCrimeDefinition(row) {
...
function cloneFailureConsequence(failureConsequence) {
...
const defaultStarterCrimeCatalog = [
...
exports.starterCrimeCatalog = defaultStarterCrimeCatalog.map((crime) => buildCrimeDefinition(crime));
function getCrimeById(crimeId) {
    return exports.starterCrimeCatalog.find((crime) => crime.id === crimeId);
}
function applyCrimeBalanceOverride(crimeId, values) {
...
function resetStarterCrimeCatalog() {
    exports.starterCrimeCatalog.forEach((crime, index) => {
